...
<tr>
<th><label for="brutew"><?php _e("Brute Work"); ?></label></th>
<td>
<input type="text" name="brutew" id="brutew" value="<?php echo esc_attr( get_the_author_meta( 'brutew', $user->ID ) ); ?>" class="regular-text" /><br />
<span class="description"><?php _e("Please enter your brute work."); ?></span>
</td>
</tr>
<tr>
<th><label for="more-info"><?php _e("More Info"); ?></label></th>
<td>
<input type="text" name="more-info" id="more-info" value="<?php echo esc_attr( get_the_author_meta( 'more-info', $user->ID ) ); ?>" class="regular-text" /><br />
<span class="description"><?php _e("Please enter more information about you."); ?></span>
</td>
</tr>
</tr>
<tr>
<th><label for="url-image"><?php _e("Url Image"); ?></label></th>
<td>
<input type="text" name="url-image" id="url-image" value="<?php echo esc_attr( get_the_author_meta( 'url-image', $user->ID ) ); ?>" class="regular-text" /><br />
<span class="description"><?php _e("Please enter the url image about you."); ?></span>
</td>
</tr>
</table>
<?php }
